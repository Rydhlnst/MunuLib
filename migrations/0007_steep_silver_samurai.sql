CREATE TYPE "public"."borrow_status" AS ENUM('PENDING', 'BORROWED', 'RETURNED');--> statement-breakpoint
...
ALTER TABLE "borrow_records" ADD CONSTRAINT "borrow_records_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;